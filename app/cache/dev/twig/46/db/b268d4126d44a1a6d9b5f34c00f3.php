...
\t\t\t\t\t<img src=";
        // line 28
        echo twig_escape_filter($this->env, $this->getContext($context, "avatar"), "html", null, true);
        echo " />
\t\t\t\t</figure>
\t\t\t\t<div id=\"avatar\">
\t\t\t\t\t<p>";
...
\t\t\t\t\t\$: ";
        // line 32
        echo twig_escape_filter($this->env, $this->getContext($context, "coins"), "html", null, true);
        echo "</p>
\t\t\t\t</div>
\t\t\t\t<div id=\"logout\">
