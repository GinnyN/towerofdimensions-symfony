...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'towerofdimensions', 'host' => '127.0.0.1', 'port' => '', 'user' => 'root', 'password' => 'imaginate56', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'AMoreSecretTokenNotQuite');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => 'AMoreSecretTokenNotQuite',
            ...
            'kernel.secret' => 'AMoreSecretTokenNotQuite',
